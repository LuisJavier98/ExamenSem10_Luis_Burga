...
import com.example.ExamenSem10_Luis_Burga.Infrastructure.Security.jwt.JwtFilter;
...
public class SegurityConfig {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests((authorize) -> authorize.requestMatchers("/api/users/post", "/api/persons/post","/api/users/login")
                        .permitAll()
                        .anyRequest()
                        .authenticated()
                )
